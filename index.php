...
<html>
	...
	<body style="margin: 0;background-color: #052335;">
		
		<div class="alltop" id="promo1">
			<div id="bgphoto" class="tall" style="background-image:url('img/blurPhoto1.png');"></div>
			<div id="bgphoto2" class="tall" style="background-image:url('img/blurPhoto2.png');"></div>
			<div id="bgphotoOverlay" class="tall"></div>
			<div id="logowrap">
				<div id="logo_s"></div>
				<div id="logo"></div>
			</div>
			<div id="photo_overlay" class="tall">
		...
		<!-- Nav -->
		<?php 
		echo file_get_contents("http://" . $_SERVER['HTTP_HOST'] . "/nav.php?class=tall&page="); 
		?>
		
		
		<div id="content_wrapper_tall" style="z-index:999; background-color:#3C2B42;">
			
			<div id="content_wrapper_sub" style="background-color:#fff;margin-bottom:0;">
				
				<div id="belownav"><a href="/transitweek/"><div 
					id="item1" class="belownavitem"><div class="belownavitem_overlay" style="background-image:url('/img/item_transitweek.png');"></div></div></a><a 
						href="/volunteer/"><div 
					id="item1" class="belownavitem midright"><div class="belownavitem_overlay" style="background-image:url('/img/item_tac.png');"></div></div></a><a 
						href="/ridethevote/"><div 
					id="item1" class="belownavitem"><div class="belownavitem_overlay" style="background-image:url('/img/item_vote.png');"></div></div></a><a 
						href="/join/"><div 
					id="item1" class="belownavitem right"><div class="belownavitem_overlay" style="background-image:url('/img/item_join.png');"></div></div></a></div>		
			</div>
			...
			<div id="content_wrapper_sub" style="background-color:#f2f2f2;background-image: url('/img/sftr_church.jpg');background-size: cover;">
				<div style="width:100%;height:100%;position:absolute;background-color:#142939;opacity: 0.8;"></div>
				<div class="content_item" style="padding-top:50px;padding-bottom:50px;">
					<h1>We're Hiring an Executive Director!</h1>
					<br>
					<div class="textoverdark">
						<span class="textoverdark_head">We couldn't more excited to announce that we're looking to hire an Executive Director.</span>
						<p>We're seeking a leader who can grow our all-volunteer grassroots organization into a staffed, powerful advocacy group. We hope to grow the organization with broad membership that continues to more effectively represent the voice of the transit rider and advocate for critical change.</p>
</div>					
<br>
						<p><a href="/jobs/" class="orange">VIEW THE JOB DESCRIPTION &raquo;</a></p>
				</div>
			</div>
