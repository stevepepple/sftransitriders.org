...
<html>
	...
	<body style="margin: 0;">
		...
		<div id="content_wrapper" style="background-color:#f4f5f0;z-index:999;">
		
			<div class="content_item" style="background-image: url('img/sf_gray.png');" id="mapbg">
				<div id="story1" class="storyBox" onMouseOut="leaveStory();" onMouseOver="hoverStory(1);" style="left: 30px; top: 40px;">
					<h1>Geary Bus Rapid Transit (BRT)</h1>
					<p>Advocating for true high-speed transit on Geary</p>
					<a href="work/#geary">LEARN MORE &raquo;</a>
				</div>
				<div id="story2" class="storyBox" onMouseOut="leaveStory();" onMouseOver="hoverStory(2);" style="left: 300px; top: 240px;">
					<h1>Van Ness Bus Rapid Transit (BRT)</h1>
					<p>Advocating for rapid transit on Van Ness</p>
					<a href="work/#vanness">LEARN MORE &raquo;</a>
				</div>
				<div id="story3" class="storyBox" onMouseOut="leaveStory();" onMouseOver="hoverStory(3);" style="left: 150px; top: 420px;">
					<h1>All-Door Boarding</h1>
					<p>Faster boarding, thanks to SF Transit Riders</p>
					<a href="work/#alldoor">LEARN MORE &raquo;</a>
				</div>
			</div>
			...
			<div id="content_wrapper_sub" style="background-color:#2c353c;background-image:url('img/honeycomb_bg.png');background-repeat: repeat-x repeat-y;">
				<div class="content_item" style="padding-top:50px;padding-bottom:50px;">
					<div class="centerquote">
						<p>Building on our past <a href="">accomplishments and victories</a>, we have an <a href="">aggressive action plan</a> for 2015.</p>
